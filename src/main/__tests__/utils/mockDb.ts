 ...
 * ORM-agnostic - pure mock objects with configurable return values.
 *
 * Use this when you need to:
 * - Test repository error handling (e.g., duplicate IDs)
 * - Control query results without database constraints
 * - Test in complete isolation from the ORM/database layer
 */
...
/**
 * Mock column interface for testing.
 */
 ...
 * Provides column accessors needed by repositories.
 */
...
/**
 * Mock update builder with fluent interface.
 */
...
/**
 * Mock insert builder with fluent interface.
 */
