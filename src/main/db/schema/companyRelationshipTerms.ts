 ...
 */
export const companyRelationshipTerms = sqliteTable(
...
export type CompanyRelationshipTermsRecord =
  typeof companyRelationshipTerms.$inferSelect;
export type NewCompanyRelationshipTermsRecord =
  typeof companyRelationshipTerms.$inferInsert;
